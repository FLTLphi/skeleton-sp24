...
public class LinkedListDeque61BTest {
    ...
    public void testGet() {
         ...
         assertThat(lld1.get(2498)).isEqualTo(null);
         assertThat(lld1.get(5)).isEqualTo(null);
         assertThat(lld1.get(3)).isEqualTo(10);
         assertThat(lld1.get(2)).isEqualTo(9);
    }
    ...
    public void testGetRecursive() {
        ...
        assertThat(lld1.getRecursive(2498)).isEqualTo(null);
        assertThat(lld1.getRecursive(5)).isEqualTo(null);
        assertThat(lld1.getRecursive(3)).isEqualTo(10);
        assertThat(lld1.getRecursive(2)).isEqualTo(9);
    }
    ...
    public void testRemoveFirstLast() {
        ...
        assertThat(lld1.toList()).containsExactly(4, 9, 10, 3).inOrder();
        assertThat(lld1.removeLast()).isEqualTo(3);
        assertThat(lld1.toList()).containsExactly(4, 9, 10).inOrder();
        assertThat(lld1.removeFirst()).isEqualTo(4);
        assertThat(lld1.toList()).containsExactly(9, 10).inOrder();
        assertThat(lld1.removeLast()).isEqualTo(10);
        assertThat(lld1.toList()).containsExactly(9).inOrder();
        assertThat(lld1.removeFirst()).isEqualTo(9);
        assertThat(lld1.isEmpty()).isTrue();
    }
}